                            ...
                            <div className="row g-0">
                                ...
                                <div className="col-8">
                                    <div className="d-grid pl-4">
                                        ...
                                        <p className="card-text"> Jeżeli chcesz się ze mną skontaktować, zadzwoń pod numer 730 373 093 lub
                            ...
                            <div className="row g-0">
                                ...
                                <div className="col-8">
                                    <div className="d-grid pl-4">
                                        ...
                                        <p className="card-text text-dark ">My name is Tomasz and I have always been an
                                            animal lover. I have three big dogs that require a lot of attencion!

                                        </p>
                                        <p className="card-text text-dark ">
                                            Tomasz is our web developer and builds our website. He ensures that it meets
                                ...
                                <div className="col-8">
                                    <div className="d-grid pl-4">
                                        ...
                                        <p className="card-text text-dark ">Lorem ipsum dolor sit amet, consectetur
                                            adipisicing elit. Amet eius ipsam itaque, nobis perspiciatis reiciendis sint
                                            sit. Consequatur, inventore, nihil. Accusantium ad aliquam doloribus, facere
                        ...
                        >
                            <div className="row g-0">
                                ...
                                <div className="col-8">
                                    ...
                                    <div className="row h-50"><div className="col-8"></div></div>
                                </div>
                            </div>
                        </div>
